...
type DetectionRequest struct {
	...
	ScopeFilter       model.Scope           `json:"scopeFilter,omitempty"`
	Query             model.DependencyQuery `json:"query"`
...
type DetectionResult struct {
	...
	Graphs         *model.GraphContainer `json:"graphs,omitempty"`
...
func (r DetectionResult) ConsolidatedGraph() (*model.Graph, error) {
...
func (d DetectorDescriptor) Clone() DetectorDescriptor {
	...
	clone.SupportedEcosystems = append([]model.Ecosystem(nil), d.SupportedEcosystems...)
	clone.SupportedManagers = append([]model.PackageManager(nil), d.SupportedManagers...)
	...
	for idx, capability := range d.RemediationCapabilities {
		...
		clone.RemediationCapabilities[idx].SupportedManagers = append([]model.PackageManager(nil), capability.SupportedManagers...)
		clone.RemediationCapabilities[idx].Actions = append([]model.RemediationAction(nil), capability.Actions...)
	}
	return clone
}
...
type RemediationCapability struct {
	SupportedManagers []model.PackageManager    `json:"supportedManagers,omitempty"`
	Actions           []model.RemediationAction `json:"actions,omitempty"`
}
...
type RemediationStrategyHint struct {
	Action model.RemediationAction `json:"action"`
...
type PackageManagerSupport struct {
	PackageManager   model.PackageManager `json:"packageManager"`
...
func Support(manager model.PackageManager, evidencePatterns ...string) PackageManagerSupport {
